...
> **⚑ ADR 0009 reframe (2026-06-05).** The **SCOPE** framing (SCOPE-Twin /
> SCOPE-Static / orbit-symmetry compression as an identifiability or
> parameter-economy lever) is **RETIRED** — the B-path broke the observational
> alias with **probe richness (data)**, not parameter-tying. Below, "SCOPE-*"
