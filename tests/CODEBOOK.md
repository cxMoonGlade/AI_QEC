...
| `stage_d_carrier_channels_targets` | carrier/channels | test_carrier_channels_units | 33 | 100/100 | 96.6% | committed (3fcc8b4); `__post_init__` contract pending |
...
`source/coupling.py` (D12, 20 units, kill 0.982, 0 exemptions). `carrier/channels.py` (D13, 33 units, the
quantum-channel library, kill 0.966) — this batch is the cautionary tale for **adversarial residual review**:
