...
from scope_static.experiments.scope_twin.gating import predict_exotic_drop_level
...
from scope_static.experiments.scope_twin.validity import predict_held_out_curve
