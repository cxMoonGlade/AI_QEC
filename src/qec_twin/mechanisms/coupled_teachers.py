"""SHIM — moved to ``error_coupling_simulator.teachers.coupled_cycle`` (MIGRATION P5, 2026-07-03).
...
"""
from error_coupling_simulator.teachers import coupled_cycle as _m
