...
from qec_twin.simulator.mcwf_backend import RDTYPE
from qec_twin.simulator.mcwf_backend import DenseQutritMcwfBackend
...
class NativeOpStreamMcwfExecutor:
    ...
    def run(
        ...
        *,
        ...
        from qec_twin.forward.kernels import qutrit_mcwf_ops_loader as _ops
