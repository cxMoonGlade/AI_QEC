...
class Axis1MechanismSelection:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "primitive_names", tuple(str(x) for x in self.primitive_names))
        object.__setattr__(self, "mechanism_pair", tuple(str(x) for x in self.mechanism_pair))
        object.__setattr__(self, "context_mechanisms", tuple(str(x) for x in self.context_mechanisms))
        object.__setattr__(self, "operation_names", tuple(str(x) for x in self.operation_names))
