...
from .stage3b0_baselines import evaluate_cluster_assignments
from .stage3b0_baselines import k_selection_runs
...
def run_stage3b1_first_discovery_model(
    *,
    ...
    result = {
        ...
        "stage": STAGE_NAME,
        "public_layer": LAYER3_LEARNER.metadata(artifact_stage=STAGE_NAME, substage="first_discovery_model"),
        "stage3a_dir": str(s3a),
