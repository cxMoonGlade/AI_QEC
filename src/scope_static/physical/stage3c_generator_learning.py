...
from .stage3b0_baselines import _load_mechanism_records
from .stage3b0_baselines import _logsumexp
from .stage3b0_baselines import _mechanism_sort_key
from .stage3b1_discovery_model import DEFAULT_OUTPUT_DIR as DEFAULT_STAGE3B1_DIR
from .stage3b1_discovery_model import _cap_folds
from .stage3b1_discovery_model import _valid_folds
...
def run_stage3c_prototype_generator_learning(
    *,
    ...
    result = {
        ...
        "stage": STAGE_NAME,
        "public_layer": LAYER3_LEARNER.metadata(artifact_stage=STAGE_NAME, substage="prototype_generator_learning"),
        "stage3a_dir": str(s3a),
