...
from scope_static.physical.phyc3c_validation import run_phyc3c_validation_audit
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--config", type=Path, default=Path("configs/scope_static/phyc3c_validation_robustness.yaml"))
