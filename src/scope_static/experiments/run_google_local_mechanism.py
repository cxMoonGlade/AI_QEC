...
from scope_static.fields import LocalFaultLogitField
from scope_static.google_mechanism import (
    dem_prior_agreement,
...
from scope_static.metrics import augment_model_comparison_metrics, evaluate_real_data_model
from scope_static.training import fit_field
from scope_static.windows import WindowPlan, window_coverage_audit_dict

from .run_google_static import (
    _fmt_float,
    _prepare_eval_cache,
...
def main(argv: list[str] | None = None) -> dict[str, object]:
    ...
    result = {
        ...
        "GDISC12_multi_context_shared_response": {
            ...
            "recommended_existing_runner": "scope_static.experiments.run_google_static with cross-context extensions",
            "no_ari": True,
        },
