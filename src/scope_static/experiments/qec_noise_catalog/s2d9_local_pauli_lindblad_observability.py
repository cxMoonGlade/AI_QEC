...
from scope_static.mechanism_observability import RZZ_FAMILY
...
def _run_one(output: Path, physical_cfg: dict[str, object], cfg: dict[str, object], run_cfg: dict[str, object]) -> dict[str, object]:
    ...
    teacher = generate_controlled_catalog_teacher_dataset(tomo_cfg, output_dir=teacher_dir, preflight_dir=run_dir / "S2D_PHYS0_preflight")
