...
<!-- code-map-inputs-sha256: 370a9d588d447167a8e3afe1481961728c9c1a89cb5642af994d18aa0f1a0a9a -->
- **code-map inputs sha256:** `370a9d588d447167a8e3afe1481961728c9c1a89cb5642af994d18aa0f1a0a9a`  •  **git HEAD:** `9ea3722`
...
| **`capeps_record_leakage_and_scaling_certification`** | `CERTIFICATION_OPEN` | `src/error_coupling_simulator/carrier/capeps/README.md`<br>`tests/test_capeps_hybrid.py` | The Clifford-augmented PEPS path has only small all-qubit untruncated-mechanics checks. It does not yet implement canonical detector/observable Records, leakage-qutrit semantics, controlled finite-bond truncation, or a scaling comparison. |
