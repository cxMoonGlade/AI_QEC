...
| [patra_gpeps_ibm_processors_2309.15642](patra_gpeps_ibm_processors_2309.15642.md) | **gPEPS heavy-hex benchmark:** simple update + mean-field readout can be spectacularly accurate for shallow, short-correlated, locally tree-like closed-unitary dynamics. Appendix C itself blocks transfer to short-loop square QEC; no qutrit/open-system/full-record bridge. |
| [kshetrimayum_quantum_advantage_tn_perspective_2603.18825](kshetrimayum_quantum_advantage_tn_perspective_2603.18825.md) | **TN method-selection review:** use effective dimension, correlation geometry, and causal structure; BP/SU become poorly controlled beyond tree-like correlations. Secondary source only—no update formula, density-PEPO, or QEC-record evidence. |
