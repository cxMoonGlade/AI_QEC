...
- sources: 36
- concept nodes: 126
- source-located relationships: 126
...
- **uses** — Non-Clifford Crosstalk Noise in Surface Codes Using Hybrid Stabilizer-Tensor Network Methods — `Sec. II, first paragraph; Fig. 1 and caption`, PDF p. 2 — The source simulates rotated-surface-code syndrome extraction repeated for \(d\) rounds, using face ancillas to measure local \(X\)- and \(Z\)-type checks. ([docs/papers/reading_notes/harper_hybrid_surface_code_2605.29514v1_source_review.md](reading_notes/harper_hybrid_surface_code_2605.29514v1_source_review.md))
