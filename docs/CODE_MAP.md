...
<!-- code-map-inputs-sha256: 10dc3cd352b8db1c3f83313a416ae328e9bd0e95a7b1a69e4f94f85991cff132 -->
- **code-map inputs sha256:** `10dc3cd352b8db1c3f83313a416ae328e9bd0e95a7b1a69e4f94f85991cff132`  •  **git HEAD:** `ed351fd`
...
---
_display inventory (excludes `__init__.py`): 15 packages, 103 modules, 163 public classes, 452 public functions (committed `src/` + dev `tools/`) + curated local-only clusters above. The release-contract count above separately includes all 104 installed package modules, including namespace facades._
