...
<!-- code-map-inputs-sha256: cdbf757d7c049606a10b427dd8a832d2a75f943e8d9b0bc949a27bb99c308003 -->
- **code-map inputs sha256:** `cdbf757d7c049606a10b427dd8a832d2a75f943e8d9b0bc949a27bb99c308003`  •  **git HEAD:** `9436636`
...
- **`axis1_mcwf_dense_certification.py`** (1437 LOC) — support: `axis1_certification_harnesses` — Dense-reference certification for the restricted MCWF/MPS carrier.
...
- **`axis1_mcwf_mps_execution.py`** (2557 LOC) — service: `restricted_axis1_1d_mps` — Fixed-microstep MCWF-over-MPS execution for Axis-1 carrier programs.
