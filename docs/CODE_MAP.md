...
<!-- code-map-inputs-sha256: a7a746b4c903168b1d240d412d0ee1be4784929f4b52ee4cb804103406ef1771 -->
- **code-map inputs sha256:** `a7a746b4c903168b1d240d412d0ee1be4784929f4b52ee4cb804103406ef1771`  •  **git HEAD:** `d72c93a`
...
- **`check_reading_order.py`** (113 LOC) — Check that docs/READING_ORDER.md still points at things that exist and are current.
    - def: `emit`, `git`, `main`
...
---
_display inventory (excludes `__init__.py`): 17 packages, 112 modules, 171 public classes, 654 public functions (committed `src/` + dev `tools/`) + curated local-only clusters above. The release-contract count above separately includes all 111 installed package modules, including namespace facades._
