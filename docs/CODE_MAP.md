...
<!-- code-map-inputs-sha256: 7691349d86f862d73aa16aa7f8290cf6cae6ae3d1575fc154b6fd8d9c0c4ba81 -->
- **code-map inputs sha256:** `7691349d86f862d73aa16aa7f8290cf6cae6ae3d1575fc154b6fd8d9c0c4ba81`  •  **git HEAD:** `21804d9`
...
- **`coupling.py`** (519 LOC) — service: `classical_finite_rtn_source_chain` — Axis-2 shared-source parameter fan-out for coupled noise processes.
...
---
_display inventory (excludes `__init__.py`): 15 packages, 103 modules, 163 public classes, 451 public functions (committed `src/` + dev `tools/`) + curated local-only clusters above. The release-contract count above separately includes all 104 installed package modules, including namespace facades._
