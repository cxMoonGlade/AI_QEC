...
<!-- code-map-inputs-sha256: af7b320ce48b2ee1aa7e44993a4718a85cc6bb2ef7c6bbcab94a1bd7c825bbc9 -->
- **code-map inputs sha256:** `af7b320ce48b2ee1aa7e44993a4718a85cc6bb2ef7c6bbcab94a1bd7c825bbc9`  •  **git HEAD:** `6203dcd`
...
- ✅ canonical ownership clean — installed modules and all 103 declared acceptance files have no executable retired-namespace import, dynamic-import, or patch-target edge.
...
- ✅ acceptance execution lanes — default `cpu_light`; `cpu_exclusive`=7, `cpu_light`=52, `gpu_serial`=44. Every acceptance file resolves to exactly one validated lane.
...
- **`service_acceptance.py`** (1724 LOC) — Run the declared simulator-service acceptance surface safely.
