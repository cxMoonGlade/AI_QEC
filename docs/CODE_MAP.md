...
<!-- code-map-inputs-sha256: c3ecd3588932a7b2f0164875a10b7dbd387c1607565c76c3c8a4a85ddad3adc3 -->
- **code-map inputs sha256:** `c3ecd3588932a7b2f0164875a10b7dbd387c1607565c76c3c8a4a85ddad3adc3`  •  **git HEAD:** `103c465`
...
- ✅ canonical ownership clean — installed modules and all 74 declared acceptance files have no executable retired-namespace import, dynamic-import, or patch-target edge.
...
- ✅ acceptance execution lanes — default `cpu_light`; `cpu_exclusive`=7, `cpu_light`=32, `gpu_serial`=35. Every acceptance file resolves to exactly one validated lane.
