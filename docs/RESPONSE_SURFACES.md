...
| Main learner claim | Stage 2 no-leakage classification/replay, then Stage 3 discovery quotient and S5 evaluator-only property audit | No-oracle visible replay/transfer |
